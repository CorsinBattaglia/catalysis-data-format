...
from cdf.normalize import spec  # requires only spec.py (no circular import)
...
def resolve_unit(value: Any, *, as_string: bool = False):
    ...
    Order:
      A) Series -> df.attrs["cdf:columns"][name]['unit']
...
def convert(x, to_unit: str, from_unit: str | None = None, *, strict: bool = False):
    ...
    if from_unit is None:
        try:
            from cdf.units.core import resolve_unit  # or correct import path
