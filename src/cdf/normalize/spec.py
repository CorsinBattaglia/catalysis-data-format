...
_STATIC_COLUMNS = {
    ...
    # -------------------------
    # CDF-specific optional quantities (catalysis / electrolyser)
    # -------------------------
    "working_electrode_potential_volt": {
        "unit": "V",
        "label_template": "Working Electrode Potential / {unit}",
        "required": False,
        "mr_name": "working_electrode_potential_volt",
        "iri": "https://w3id.org/catalysis-data-format/ontology/catalysis-data-format#working_electrode_potential_volt",
        "synonyms": [
            "working-electrode-potential", "we-potential", "ewe", "working-electrode-voltage",
        ],
    },
    "counter_electrode_potential_volt": {
        "unit": "V",
        "label_template": "Counter Electrode Potential / {unit}",
        "required": False,
        "mr_name": "counter_electrode_potential_volt",
        "iri": "https://w3id.org/catalysis-data-format/ontology/catalysis-data-format#counter_electrode_potential_volt",
        "synonyms": [
            "counter-electrode-potential", "ce-potential", "ece", "counter-electrode-voltage",
        ],
    },
    "reference_electrode_potential_volt": {
        "unit": "V",
        "label_template": "Reference Electrode Potential / {unit}",
        "required": False,
        "mr_name": "reference_electrode_potential_volt",
        "iri": "https://w3id.org/catalysis-data-format/ontology/catalysis-data-format#reference_electrode_potential_volt",
        "synonyms": [
            "reference-electrode-potential", "re-potential", "ere", "reference-electrode-voltage",
        ],
    },
    "cell_resistance_ohm": {
        "unit": "ohm",
        "label_template": "Cell Resistance / {unit}",
        "required": False,
        "mr_name": "cell_resistance_ohm",
        "iri": "https://w3id.org/catalysis-data-format/ontology/catalysis-data-format#cell_resistance_ohm",
        "synonyms": [
            "cell-resistance", "r-cell", "rcell", "ohmic-cell-resistance",
        ],
    },
    "faradaic_efficiency_percent": {
        "unit": "%",
        "label_template": "Faradaic Efficiency / {unit}",
        "required": False,
        "mr_name": "faradaic_efficiency_percent",
        "iri": "https://w3id.org/catalysis-data-format/ontology/catalysis-data-format#faradaic_efficiency_percent",
        "synonyms": [
            "faradaic-efficiency", "fe", "coulombic-efficiency", "current-efficiency",
        ],
    },
    "gas_flow_rate_ml_min": {
        "unit": "mL/min",
        "label_template": "Gas Flow Rate / {unit}",
        "required": False,
        "mr_name": "gas_flow_rate_ml_min",
        "iri": "https://w3id.org/catalysis-data-format/ontology/catalysis-data-format#gas_flow_rate_ml_min",
        "synonyms": [
            "gas-flow-rate", "flow-rate", "flow", "gas-flow",
        ],
    },
    "electrolyte_ph": {
        "unit": "1",
        "label_template": "Electrolyte pH / {unit}",
        "required": False,
        "mr_name": "electrolyte_ph",
        "iri": "https://w3id.org/catalysis-data-format/ontology/catalysis-data-format#electrolyte_ph",
        "synonyms": [
            "ph", "electrolyte-ph", "solution-ph",
        ],
    },
    "product_concentration_mol_l": {
        "unit": "mol/L",
        "label_template": "Product Concentration / {unit}",
        "required": False,
        "mr_name": "product_concentration_mol_l",
        "iri": "https://w3id.org/catalysis-data-format/ontology/catalysis-data-format#product_concentration_mol_l",
        "synonyms": [
            "product-concentration", "concentration", "product-conc", "conc",
        ],
    },
}
