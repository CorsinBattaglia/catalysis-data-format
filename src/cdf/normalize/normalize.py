# src/cdf/normalize/normalize.py
...
from cdf.ontology_labels import load_alias_index
from cdf.units import convert_series, parse_from_header
...
def guess_plugin_by_columns(df: pd.DataFrame, *, current_id: str | None = None):
    ...
    """
    try:
        from cdf.data_sources import all_plugins
    except Exception:
        return None
