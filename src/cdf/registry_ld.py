...
def _require_rdflib():
    try:
        ...
        raise RuntimeError(
            ...
            "Install with `pip install catalysisdf`."
        ) from exc
    return rdflib
...
def _extract_property_values(graph: Any, node: Any, schema: Any, schema_http: Any) -> dict[str, Any]:
    ...
    rdfs = rdflib.RDFS
    prop_map = {
        "cdf:chemistry": "chemistry",
        "cdf:form_factor": "form_factor",
        "cdf:nominal_voltage_v": "nominal_voltage_v",
        "cdf:rated_capacity_ah": "rated_capacity_ah",
        "cdf:rated_energy_wh": "rated_energy_wh",
        "cdf:mass_g": "mass_g",
        "cdf:volume_l": "volume_l",
    }
    label_map = {
