...
from cdf.units import convert, resolve_unit  # <- streamlined: use the units package
...
def plot(
    ...
    *,
    ...
    Publication-style BDF plot:
      ...
      - Unit conversion via xunit/yunit/yyunit (Pint via cdf.units.convert)
